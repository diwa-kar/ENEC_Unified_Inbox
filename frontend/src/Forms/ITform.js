  ...
  return (
    <>
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, rgba(130, 0, 0,0.5), rgba(158, 111, 33,0.5), url('https://www.cdegroup.com/getmedia/4489abf9-d22f-4738-b34c-9ce01bbf5317/QPMC-BETWEEN-STOCKPILERS-670x520.jpg?width=670&height=520&ext=.jpg')",
          height: "100vh",
        ...
        <div className="form">
          ...
          <Grid container>
            <Grid
              ...
              xs={5}
            >
              <Typography sx={{ paddingRight: 2 }} variant="subtitle1">
                {"Type of Hardware:"}
              </Typography>
            </Grid>
            <Grid item xs={7}>
